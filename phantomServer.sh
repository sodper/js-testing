...
if [[ $COMMAND == "start" ]]; then
    ...
    nohup java -jar $ROOTDIR/jars/jsTestDriver.jar --config jsTestDriver.conf --port 9876 > $ROOTDIR/testOutputDir/jstd.out 2> $ROOTDIR/testOutputDir/jstd.err < /dev/null &
